  ...
  return (
    <div className="bg-[#2B2C37] w-11/12 flex flex-col gap-8 rounded-[6px] p-8 absolute">
      ...
      <div className="flex flex-col gap-5">
        <button onClick={() => onDelete(id)} className="bg-[#EA5555] text-center p-3 text-white text-[13px] font-bold rounded-3xl">
          Delete
        </button>
        <button onClick={() => onCancel(id)} className="bg-white text-center p-3 text-[#635FC7] text-[13px] font-bold rounded-3xl">
          Cancel
        </button>
      </div>
    </div>
